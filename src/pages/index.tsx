  ...
  return (
    <FrontLayout>
      ...
      <div className="message">
        {`
当プロジェクトの目的は、ブロックチェーンが普及するための阻害要因となっている問題を解決することです。
ブロックチェーンのアドレス（アカウント）を各自が保有し、それを様々なサービスをまたいだIDとして使用できるために必要な考え方とUXを提案します。
...
・これによって、外部サービスへのログインであっても、ECサイトの決済であっても、自分のスマホ上のアプリに「メッセージ」として通知され「YES]か「NO」を選択するだけ、という一律のUIを実現すること
